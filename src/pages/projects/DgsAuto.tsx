...
// 🖼️ Hero image (mets ton vrai visuel ici)
import heroImg from "../../assets/images/dgs.png";

// 🖥️ Captures VS Code (adapte les noms si besoin)
...
export default function DgsAuto() {
  ...
  const goBackToProjects = () => {
    ...
    navigate("/#projects");
    // petit délai pour laisser React Router changer la route avant scroll
    setTimeout(() => {
      document
  ...
  return (
    <div className="project-detail-container">
      ...
      <div className="project-hero">
        <div className="project-hero-left">
          ...
          <p className="project-intro">
            Plateforme web de <b>vente</b> et <b>location</b> de véhicules en
            Côte d’Ivoire, avec un <b>espace administrateur</b> complet pour la
      ...
      <section className="project-section">
        <h2>Contexte</h2>
        <p>
          Le client souhaitait une présence en ligne professionnelle pour
          présenter ses véhicules et recevoir des demandes de <b>vente</b> /{" "}
          <b>location</b>, tout en gardant la main grâce à une interface
      ...
      <section className="project-section">
        ...
        <div className="features-grid">
          <div className="feature-card">
            ...
            <p>
              Affichage du catalogue avec fiches détaillées (prix, photos, infos
              clés).
            </p>
          </div>
          <div className="feature-card">
          ...
          <div className="feature-card">
            ...
            <p>
              Formulaires pour contacter l’entreprise et enregistrer les
              demandes.
            </p>
          </div>
          <div className="feature-card">
            ...
            <p>
              Connexion sécurisée + gestion du contenu (CRUD véhicules,
              demandes, etc.).
            </p>
          </div>
        </div>
      ...
      <section className="project-section">
        ...
        <ul>
          ...
          <li>
            Sécurisation : authentification, protections, séparation admin
          </li>
      ...
      <section className="project-section">
        ...
        <p className="pd-note">
          Stack volontairement légère : rapide, simple à maintenir, parfaitement
          adaptée à un hébergement mutualisé.
        </p>
      </section>
      ...
      <section className="project-section">
        ...
        <p className="carousel-hint">
          Astuce : tu peux remplacer ce carousel par une grille si tu préfères
          montrer 4 images d’un coup.
        </p>
      </section>
